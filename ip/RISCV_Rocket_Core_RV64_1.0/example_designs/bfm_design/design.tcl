proc create_ipi_design { offsetfile design_name } {
	...
	set RISCV_Rocket_Core_RV64_0 [ create_bd_cell -type ip -vlnv user.org:user:RISCV_Rocket_Core_RV64:1.0 RISCV_Rocket_Core_RV64_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI] [get_bd_intf_pins RISCV_Rocket_Core_RV64_0/S_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_ACLK] [get_bd_pins RISCV_Rocket_Core_RV64_0/S_AXI_ACLK]
...
connect_bd_intf_net [get_bd_intf_pins slave_1/S_AXI] [get_bd_intf_pins RISCV_Rocket_Core_RV64_0/M1_AXI]
	...
	set offset_file "${bd_path}/RISCV_Rocket_Core_RV64_v1_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef RISCV_Rocket_Core_RV64_v1_0_tb_include_vh_"
	puts $fp "`define RISCV_Rocket_Core_RV64_v1_0_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:RISCV_Rocket_Core_RV64:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/RISCV_Rocket_Core_RV64_v1_0_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "RISCV_Rocket_Core_RV64_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 RISCV_Rocket_Core_RV64_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top RISCV_Rocket_Core_RV64_v1_0_tb [get_filesets sim_1]
