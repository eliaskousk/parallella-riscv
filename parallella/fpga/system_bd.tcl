...
CONFIG.NUM_PORTS {16} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_25M/ext_reset_in] [get_bd_pins proc_sys_reset_0/ext_reset_in]
