...
librecores.org:user:parallella_base:1.0\
...
proc create_root_design { parentCell } {
  ...
  set parallella_base_0 [ create_bd_cell -type ip -vlnv librecores.org:user:parallella_base:1.0 parallella_base_0 ]
  set_property -dict [ list \
   CONFIG.NGPIO {12} \
 ] $parallella_base_0
  ...
  set rv64_mmcm_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 rv64_mmcm_0 ]
  set_property -dict [ list \
  ...
  set rv64_sys_reset_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rv64_sys_reset_0 ]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins RISCV_Rocket_Core_RV64_0/m_axi_aclk] [get_bd_pins RISCV_Rocket_Core_RV64_0/s_axi_aclk] [get_bd_pins axi_mem_intercon_PS_master/ACLK] [get_bd_pins axi_mem_intercon_PS_master/M00_ACLK] [get_bd_pins axi_mem_intercon_PS_master/S00_ACLK] [get_bd_pins axi_mem_intercon_PS_slave/ACLK] [get_bd_pins axi_mem_intercon_PS_slave/M00_ACLK] [get_bd_pins axi_mem_intercon_PS_slave/S00_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rv64_mmcm_0/clk_out1] [get_bd_pins rv64_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins processing_system7_0/FCLK_CLK3] [get_bd_pins rv64_mmcm_0/clk_in1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rv64_mmcm_0/resetn] [get_bd_pins rv64_sys_reset_0/ext_reset_in]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces RISCV_Rocket_Core_RV64_0/m_axi] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
